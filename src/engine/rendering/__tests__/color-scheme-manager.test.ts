...
describe('ColorSchemeManager', () => {
  ...
  it('should be able to get age of elset color scheme', () => {
    const test = (sat: BaseObject) =>
      colorSchemeManager.colorSchemeInstances.GpAgeColorScheme.update(sat, {jday: 1,
        year: 23 });
  ...
  it('should be able to get neighbors color scheme', () => {
    ...
    const test = (sat: BaseObject) =>
      colorSchemeManager.colorSchemeInstances.OrbitalPlaneDensityColorScheme.update(sat, {orbitalPlaneDensity: orbitDensityMatrix,
