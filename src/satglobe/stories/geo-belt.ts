...
export const geoBeltStory: StoryManifestV1 = storyManifestV1Schema.parse({
  ...
  beats: [
    ...
    },
    {
      ...
      encoding: 'orbit-regime',
      filterOverrides: { regimes: ['geo'], status: 'active' },
      reconstruction: 'reconstructed',
      scaleMode: 'semantic',
    },
    {
      id: 'why-it-matters',
      eyebrow: '03 / THE POPULATED BELT',
      title: 'The active belt, not a three-point diagram',
      dateLabel: 'Installed active GEO snapshot',
      narration: 'Three evenly spaced satellites at this altitude can provide near-global coverage. This view does not stage that three-satellite geometry: it shows the installed active geosynchronous population, a belt shaped by the same valuable coverage advantage.',
      factIds: ['geo-coverage', 'geo-purpose', 'geo-elements'],
      durationMs: 12_000,
